...
//O codigo a seguir tem como objetivo gerar e validar 7 numeros sendo maiores ou menores que 5.
...
programa
{
	...
	funcao inicio()
	{
		...
		sortear()
		verifica()
		escreva("\n O total de numeros menores a '5' é: ",menor)
		escreva("\n O total de numeros maiores ou igual a '5' é: ",maior)
